...
background-image: url("imagenes/fondoWeb.jpg");
    ...
    <input type="submit" class="btn btn-danger" name="vuelve" value="Salir"> 
        ...
        <h1>Listado de Peticiones de Eventos de la empresa</h1><br>
		...
		<thead>
			<tr style="height: 18px; border: 2px solid #000000; background-color: #e3e3e3; ">
				...
				<th style="text-align: left;">Seguidores del Medio Solicitante</th>
                                 <th style="text-align: left;">Evento solicitado</th>
                                 <th style="text-align: left;">Plazas restante</th>
...
<tr>
    ...
    <td>{$medioU[0]["visitas"]}</td>
     <td>{$medioU[0]["seguidores"]}</td>
      ...
      <td>{$productos[{$numero}][0]["plazas"]}</td>
      <td><a href='{$array[{$numero}]["cobertura"]}' target="_blank">{$array[{$numero}]["cobertura"]}</a></td>
            ...
            <input type="submit" name="cambiar" value="Cambiar Seguimiento" >
        </form></td>
</tr>
{/foreach}
