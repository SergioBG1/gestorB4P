...
height:40%;
    ...
    <input type="submit" class="btn btn-danger" name="vuelve" value="Salir"> 
        ...
        <h1>Proporcionar información del evento</h1><br>
          {$texto}
         <form method="POST" action="listadoPeticionesEventosRespuesta.php">
             <input class="tam" type="text" name="seguimiento" height="40%">   <br><br>
